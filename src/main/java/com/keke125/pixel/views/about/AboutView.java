...
@AnonymousAllowed
public class AboutView extends VerticalLayout implements LocaleChangeObserver {
    ...
    private final Html privacy;

    private final String privacyTextEN;

    private final String privacyTextTC;

    public AboutView(AppConfig appConfig) {
        aboutHeader = new H3(translator.getTranslation("About",
        ...
        privacyTextEN = Jsoup.clean("<h1>Privacy Policy</h1>" +
                ...
                "of the <a href=https://www.freeprivacypolicy" +
                ".com/free-privacy-policy-generator/ target=_blank>Free " +
                ...
                "<ul>" +
                "<li>" +
                "<p><strong>Account</strong> means a unique account created " +
                "for You to access our Service or parts of our Service.</p>" +
                "</li>" +
                "<li>" +
                "<p><strong>Affiliate</strong> means an entity that controls," +
                ...
                " Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;" +
                "Our&quot; in this Agreement) refers to Pixel Art Filter Web" +
                ".</p>" +
                "</li>" +
                "<li>" +
                "<p><strong>Cookies</strong> are small files that are placed " +
                ...
                appConfig.getWebCountry() + "</p>" +
                "</li>" +
                "<li>" +
                "<p><strong>Device</strong> means any device that can access " +
                "the Service such as a computer, a cellphone or a digital " +
                "tablet.</p>" +
                "</li>" +
                "<li>" +
                "<p><strong>Personal Data</strong> is any information that " +
                ...
                appConfig.getWebNameEN() + ", accessible from <a href=" +
                appConfig.getWebLink() + " rel=external nofollow noopener " +
                "target=_blank>" +
                appConfig.getWebLink() + "</a></p>" +
                "</li>" +
                "<li>" +
                "<p><strong>You</strong> means the individual accessing or " +
                ...
                " collect and track information and to improve and analyze " +
                ...
                "Cookies, our Service may use Cookies.</li>" +
                ...
                "personal computer or mobile device when You go offline, " +
                "while Session Cookies are deleted as soon as You close Your " +
                "web browser. Learn more about cookies on the <a " +
                "href=https://www.freeprivacypolicy" +
                ".com/blog/sample-privacy-policy-template" +
                "/#Use_Of_Cookies_And_Tracking target=_blank>Free Privacy " +
                "Policy website</a> article.</p>" +
                "<p>We use both Session and Persistent Cookies for the " +
                ...
                "</li>" +
                "<li>" +
                "<p><strong>Cookies Policy / Notice Acceptance " +
                "Cookies</strong></p>" +
                "<p>Type: Persistent Cookies</p>" +
                "<p>Administered by: Us</p>" +
                "<p>Purpose: These Cookies identify if users have accepted " +
                "the use of cookies on the Website.</p>" +
                "</li>" +
                "<li>" +
                ...
                "</li>" +
                "<li>" +
                "<p><strong>To contact You:</strong> To contact You by email," +
                ...
                "</li>" +
                "<li>" +
                "<p><strong>To manage Your requests:</strong> To attend and " +
                "manage Your requests to Us.</p>" +
                "</li>" +
                "<li>" +
                ...
                "</li>" +
                "<li>" +
                "<p><strong>For other purposes</strong>: We may use Your " +
                ...
                "Company</li>" +
                "<li>Prevent or investigate possible wrongdoing in connection" +
                " with the Service</li>" +
        ...
        privacyTextTC = Jsoup.clean("<div class=statement textzone>" +
                ...
                "</ol>" +
                "<p class=p1 " +
                "p3>（三）本網站委託廠商協助蒐集、處理或利用您的個人資料時，將對委外廠商或個人善盡監督管理之責。</p>" +
                "<p>六、 Cookie 之使用</p>" +
                "<p class=p2>為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的Cookie，若您不願接受 " +
                "Cookie 的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，或關閉cookie，即可拒絕 Cookie " +
                "的寫入，但可能會導至網站某些功能無法正常執行 。</p>" +
                "<p>七、 隱私權保護政策之修正</p>" +
                " <p class=p2>本網站隱私權保護政策將因應需求隨時進行修正，修正後的條款將刊登於網站上。</p>" +
                "</div>", Safelist.basic());
        add(aboutHeader);

        githubHeader = new H3(translator.getTranslation("Github-link",
                UI.getCurrent().getLocale()));
        githubHeader.addClassNames(Margin.Top.LARGE, Margin.Bottom.MEDIUM);
        githubLink = new Anchor("https://github.com/keke125/pixel-art-filter" +
                "-web", translator.getTranslation("Pixel-Art-Filter-Web" +
                "-Github", UI.getCurrent().getLocale()));
        githubLink.setTarget("_blank");
        add(githubHeader, githubLink);

        privacyHeader = new H3(translator.getTranslation("Privacy-policy",
                UI.getCurrent().getLocale()));
        privacyHeader.addClassNames(Margin.Top.LARGE, Margin.Bottom.MEDIUM);
        if (getLocale().equals(Translator.LOCALE_ZHT)) {
            privacy = new Html("<text>" + privacyTextTC + "</text>");
        } else {
            privacy = new Html("<text>" + privacyTextEN + "</text>");
        }
        add(privacyHeader, privacy);
    }

    @Override
    public void localeChange(LocaleChangeEvent localeChangeEvent) {
        aboutHeader.setText(translator.getTranslation("About",
                UI.getCurrent().getLocale()));
        githubHeader.setText(translator.getTranslation("Github-link",
                UI.getCurrent().getLocale()));
        githubLink.setText(translator.getTranslation("Pixel-Art-Filter-Web" +
                "-Github", UI.getCurrent().getLocale()));
        privacyHeader.setText(translator.getTranslation("Privacy-policy",
                UI.getCurrent().getLocale()));
        if (getLocale().equals(Translator.LOCALE_ZHT)) {
            privacy.setHtmlContent("<text>" + privacyTextTC + "</text>");
        } else {
            privacy.setHtmlContent("<text>" + privacyTextEN + "</text>");
        }
    }
}
