...
public class AboutView extends VerticalLayout {
    ...
    String privacyText = Jsoup.clean("<h1>Privacy Policy</h1>" +
    ...
    public AboutView() {
        ...
        H3 githubHeader = new H3("Github Link");
        githubHeader.addClassNames(Margin.Top.LARGE, Margin.Bottom.MEDIUM);
        Anchor githubOriginal = new Anchor("https://github.com/keke125/pixel-art-filter-web", "Pixel Art Filter WebGithub");
        githubOriginal.setTarget("_blank");
        add(githubHeader, githubOriginal);

        H3 privacyHeader = new H3("Privacy Policy");
        privacyHeader.addClassNames(Margin.Top.LARGE, Margin.Bottom.MEDIUM);
        Html privacy = new Html("<text>" + privacyText + "</text>");
